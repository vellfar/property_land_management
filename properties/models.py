...
class Document(models.Model):
    land_property = models.ForeignKey(LandProperty, on_delete=models.SET_NULL, related_name='documents', null=True)
...
class OwnershipTransfer(models.Model):
    ...
    land_property = models.ForeignKey(LandProperty, on_delete=models.SET_NULL, related_name='transfers', null=True)
    ...
    def __str__(self):
        return f"Transfer {self.land_property} - {self.status}"
